...
class VQLPIPSWithDiscriminator(nn.Module):
    def __init__(self, disc_start, codebook_weight=0., pixelloss_weight=1.0,
                 ...
                 vq_weight = 0.25, codebook_enlarge_ratio=0, codebook_enlarge_steps=2000,
    ...
    def forward(self, codebook_loss, loss_break, inputs, reconstructions, optimizer_idx,
        ...
        if optimizer_idx == 0:
            ...
            loss = nll_loss + g_loss + scale_codebook_loss + loss_break.vqloss * self.vq_weight
            if disc_factor == 0:
                log = {"{}/total_loss".format(split): loss.clone().detach(),
                       ...
                       "{}/vq_loss".format(split): loss_break.vqloss.detach(),
